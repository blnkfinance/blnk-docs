...
const response = await blnk.ApiKeys.list({ owner: 'payments-team' });
```
</CodeGroup>
...
```typescript TypeScript wrap
await blnk.ApiKeys.delete('api_key_879f0ecb-e29f-4137-801b-1048366381db', {
  owner: 'payments-team',
});
```
</CodeGroup>

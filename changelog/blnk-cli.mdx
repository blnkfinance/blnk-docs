...
<Update label="1.8.3" description="Aug 20, 2026">
  ## Fixes & improvements

  **`blnk --version`** now reads the version from `package.json` instead of a hardcoded value, so the reported version always matches the installed package.
</Update>

...
<Update label="August 2026">
  ...
  On a managed instance, Insights is a DuckDB SQL workbench against the instance data lake. Save queries, run them over a date range, and start from built-in templates.

  <img src="/cloud/img/insights/insights-sql-workbench.png" alt="Insights SQL workbench with a saved query, date range, Run button, and results table" className="rounded-lg" />

  Learn more in our [Insights guide](/cloud/insights/overview) and [Create new query](/cloud/reference/create-new-query).

  ## Fund lineage in Cloud

  Tag credits with a provider when the destination balance has lineage enabled. Open a lineage-enabled balance to see totals, available, and spent per provider. Open a debit to see how that spend was allocated.

  Filter the Balances table by allocation strategy and whether fund lineage is enabled.

  <img src="/cloud/img/balances/fund-lineage-table.png" alt="Fund lineage table on a balance showing provider totals, available, and spent" className="rounded-lg" />

  Learn more in our [Fund lineage guide](/cloud/transactions/fund-lineage).

  ## Notification settings

  Choose which Cloud emails you receive from **Settings > Notifications**. For deployment anomalies, set how many detections in a time window trigger mail, and whether you get a daily recap.

  <img src="/cloud/img/settings/notification-settings.png" alt="Notification settings for deployment anomalies and daily summary" className="rounded-lg" />

  Learn more in our [Notification settings guide](/cloud/account/notifications).
</Update>

<Update label="July 2026">
  ## Production instances

  Deploy a Production managed Core from Cloud: dedicated infrastructure, region selection, high availability, backups, and a built-in data lake.

  Learn more in our [Managed instances guide](/cloud/instances/deploy).

  ## Usage billing

  Track record usage per instance in **Settings > Billing**. Opt in to usage-based billing when you pass the included record limit, or stop creating new records until the next cycle.

  Learn more in our [Billing guide](/cloud/organization/billing).

  ## Pin apps for the team

  From the Apps library, the pin icon is **Pin to sidebar for your team**. That pin is for the whole organization, not only the person who clicked it.

  Learn more in [Install a Custom App](/cloud/apps/install-app#pin-an-app-for-your-team).

  ## Alert description

  Edit an alert description in markdown after it is created, and `@mention` teammates.

  <img src="/cloud/img/alerts/alert-description-mention.png" alt="Alert description editor with teammate mention suggestions" className="rounded-lg" />

  Learn more in our [Alert description guide](/cloud/alerts/description).
</Update>
...
<Update label="June 2026">
  ...
  Learn more in our [Monitoring guide](/cloud/monitoring/overview).
  ...
  Open the command palette from anywhere in Cloud to jump to pages, run actions, and filter ledger data (for example type `identity_id`).
...
<Update label="April 2026">
  ...
  Learn more in our [API Keys guide](/cloud/reference/api-keys).
...
<Update label="January 2026">
  ...
  * **MCP (Model Context Protocol)**: Interact with your Blnk Core and Cloud workspace from AI assistants like Cursor, Claude Desktop, and ChatGPT. Get your MCP endpoint from **Settings > MCP** and add it to your tool. Learn more in our [MCP server](/cloud/reference/mcp).

  * **API Keys**: You can now create and manage API keys for your workspace. Use API keys to authenticate programmatic access to Blnk Cloud and integrate with your applications and workflows. Learn more in our [API Keys guide](/cloud/reference/api-keys).

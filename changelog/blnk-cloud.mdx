...
<Update label="January 2026">
  ...
  * **MCP (Model Context Protocol)**: Interact with your Blnk Core and Cloud workspace from AI tools like Cursor, Claude Desktop, and ChatGPT. Get your MCP endpoint from **Settings > MCP** and add it to your tool. Learn more in our [MCP server](/cloud/reference/mcp).

...
<Note>
Upgrading from `0.14.0` to `0.15.4` means reading 0.14.3, 0.15.0, 0.15.1, then 0.15.4 before you deploy.
</Note>
...
**Example:** on `0.12.1` going to `0.15.4`, read 0.13.2, then 0.14.0, then 0.15.0, then 0.15.1, then 0.15.4. Skip guides at or below your current version.
</Step>

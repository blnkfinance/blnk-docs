...
<Note>
Upgrading from `0.10.4` to `0.15.3` means reading 0.10.5, 0.11.0, 0.12.0, 0.13.2, 0.14.0, 0.15.0, then 0.15.1 before you deploy.
</Note>
...
**Example:** on `0.12.1` going to `0.15.3`, read 0.13.2, then 0.14.0, then 0.15.0, then 0.15.1. Skip guides at or below your current version.
</Step>

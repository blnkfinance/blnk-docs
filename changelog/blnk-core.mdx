...
<Update label="Jun 21, 2025" description="v0.10.3">
  ## Enhanced transaction handling & performance
  ...
  **Enhanced transaction processing**  
  ...
  - Enhanced async transaction flow with polling for status tracking
  ...
  **Monitoring & Health Checks**  
  ...
  1. **Prevent double refunds**: Implemented safeguards to prevent duplicate refund processing, ensuring financial accuracy
  2. **Improved locking mechanisms**: Enhanced balance creation locking to prevent concurrent access issues
  3. **Transaction lock duration**: Better handling of transaction lock timeouts and duration configuration
  4. **Webhook reliability**: Fixed webhook client initialization and processing issues
  5. **General system stability**: Various minor fixes and performance optimizations throughout the system

  <Card title="Enhanced Financial Processing" href="/transactions/introduction" icon="credit-card" iconType="duotone">
    Learn more about improved transaction handling and processing capabilities
  </Card>
</Update>

...
<Update label="Jun 21, 2025" description="v0.10.3">
  ...
  This release includes significant improvements to core ledger functionality and developer experience. Please refer to the [full release notes](https://github.com/blnkfinance/blnk/releases/tag/v0.10.3) for complete details on all features and changes.

  ## Key Improvements
  
  1. **Performance Enhancements**: Optimized transaction processing and balance calculations for improved system performance.
  2. **API Improvements**: Enhanced API responses and error handling for better developer experience.
  3. **Database Optimizations**: Improved database queries and indexing for faster data retrieval.
  4. **Security Updates**: Enhanced security measures and validation processes.

  ## Bug fixes & improvements
  
  1. Resolved issues with concurrent transaction processing
  2. Fixed edge cases in balance computation algorithms  
  3. Improved error messaging and logging throughout the system
  4. Enhanced data validation and input sanitization
  5. General stability improvements and performance optimizations

  <Card title="View Full Release Notes" href="https://github.com/blnkfinance/blnk/releases/tag/v0.10.3" icon="external-link" iconType="duotone">
    See the complete changelog and technical details on GitHub
  </Card>
</Update>

...
<Update label="0.15.0" description="Jul 6, 2026">
  ...
  4. Increased default worker and database pool limits and added configurable request and upload size caps.
  5. Changed reconciliation start endpoints to return only `reconciliation_id`; poll for full status.
</Update>

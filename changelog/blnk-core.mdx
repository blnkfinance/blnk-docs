...
<Update label="0.15.1" description="Jul 17, 2026">
  ...
  1. **Transaction lock duration:** Fixed an overflow bug when applying `BLNK_TRANSACTION_LOCK_DURATION`. [Lock settings →](/advanced/configuration/transactions#lock-settings)

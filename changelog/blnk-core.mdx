...
<Update label="Jan 14, 2026" description="v0.12.2">
  ...
  2. **Fixed Search date field updates**: Resolved an issue where date fields were incorrectly updated in the [Search](/search/typesense/overview) index when metadata was modified.

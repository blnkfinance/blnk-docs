...
<Update label="Feb 26, 2024" description="v0.8.8">
  ## PII Tokenization
...
<Update label="Feb 25, 2024" description="v0.8.7">
  ## Bug fixes & improvements
  
  1. General bug fixes and improvements.
  2. Added environment variables for Blnk configuration parameters.
</Update>
<Update label="Feb 24, 2024" description="v0.8.5">
  ## Bug fixes & improvements
  
  1. General bug fixes and improvements.
</Update>
<Update label="Feb 24, 2024" description="v0.8.4">
...
<Update label="Feb 22, 2024" description="v0.8.3">
...
<Update label="Feb 7, 2024" description="v0.8.2">
...
<Update label="Jan 18, 2024" description="v0.8.1">

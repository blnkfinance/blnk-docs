...
<Update label="0.15.0" description="Jul 6, 2026">
  ...
  [Updating inflight transactions →](/transactions/inflight)
...
<Update label="0.14.4" description="Jun 6, 2026">
  ...
  1. **Scheduled inflight commits:** Fixed a bug where [scheduled inflight commits](/transactions/inflight#schedule-inflight-commits) did not commit at the time you set. Transactions with `inflight_commit_date` now commit automatically as expected.

...
<Update label="Jun 9, 2024" description="v0.6.3">
  ...
  - Added `precision` to balance monitor.
  - Added restart policy to migration.

  ## Changelog

  - Directus service and `.env` parameters added in **docker-compose** by [vebera](https://github.com/vebera).
</Update>

...
<Update label="Jun 21, 2025" description="v0.10.3">
  ...
  Please refer to the [GitHub release notes](https://github.com/blnkfinance/blnk/releases/tag/v0.10.3) for the complete list of features, improvements, and bug fixes included in this release.

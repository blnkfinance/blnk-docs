...
<Update label="Mar 16, 2025" description="v0.10.0">
  ...
  * Submit an array of transactions from your external records.
  * Set your [reconciliation strategy](/reconciliations/strategies) and [matching rules](/reconciliations/matching-rules).
  * Start your reconciliation
...

  {
    "external_transactions": [
      {
        "id": "txn1dddddddd3ddddsdd4d5",
        "amount": 3.99,
        "reference": "INV-2023-001",
        "currency": "GBP",
        "description": "Wallet funding",
        "date": "2024-11-15T14:39:45Z",
        "source": "bank-api"
      }
    ],
    "strategy": "one_to_one",
  ...
  ```
  ```json Reconciled transaction {14-18}
  {
    "precise_amount": 399,
    "amount": 3.99,
    "precision": 100,
    "transaction_id": "txn_0663f932-61c7-47aa-98c0-979b1df636e9",
    ...
    "description": "Wallet funding",
    "status": "APPLIED",
    "created_at": "2024-11-15T14:39:45.123732",
    "meta_data": {
      "external_txn_id": "txn1dddddddd3ddddsdd4d5",
      "reconciled": true,
      "reconciled_at": "2024-11-15T17:34:11.123732",
      "reconciliation_amount": 3.99,
      "reconciliation_id": "recon_01394cb8-a3f6-47e0-b656-4fb9a93fa951"
    }
  }
  ```
  </CodeGroup>
  ...
  To learn more about this feature: [How Balance Reconciliation Works →](/balances/balance-reconciliation)

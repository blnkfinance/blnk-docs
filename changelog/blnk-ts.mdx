...
<Update label="1.5.0" description="Sep 24, 2026">
  ...
  `Search.multiSearch` sends several Typesense searches in one `POST /multi-search` request. See [Search via Typesense](/reference/search-typesense) and the [TypeScript search page](/sdks/typescript/search/search-typesense).

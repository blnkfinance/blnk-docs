---
title: "0.12.0 Migration Guide"
sidebarTitle: "Migration to 0.12.0"
icon: "arrow-right"
...
<Step title="Verify authentication">
  ...
  curl -X GET "http://localhost:5001/ledgers" \
    -H "X-blnk-key: <your-stored-plain-text-key>"
  ```
...
<RelatedTopics
  items={[
    { title: "v13.2 migration", href: "/changelog/v13-2-migration" },

...
sidebarTitle: "Migration to 0.15.0"
icon: "arrow-right"
description: "Migration guide for upgrading to v0.15.0, covering error codes, HTTP statuses, removed response fields, and bulk inflight commit/void."
---

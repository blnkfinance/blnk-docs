...
[Search](/search/overview) is used to query and find data in your Blnk server. To search your balances with the Blnk CLI, you can use the following options with the `blnk balacnes list` command.

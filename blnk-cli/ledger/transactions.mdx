...
| `<currency>` | Short code for your asset class. See also: [Asset classes](/balances/asset-classes). |
...
[Search](/search/overview) is used to query and find data in your Blnk server. To search your transactions with the Blnk CLI, you can use the following options with the `blnk transactions list` command.

...
[Search](/search/typesense/introduction) is used to query and find data in your Blnk server. To search your transactions with the Blnk CLI, you can use the following options with the `blnk transactions list` command.

...
[Search](/search/typesense/overview) is used to query and find data in your Blnk server. To search your ledgers with the Blnk CLI, you can use the following options with the `blnk ledgers list` command.

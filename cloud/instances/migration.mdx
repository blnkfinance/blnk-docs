---
title: "Migrate your instance in or out of Blnk Cloud"
sidebarTitle: "Migrate your instance"
icon: "cloud-upload"
description: "Learn how to migrate your data from a self-hosted Core instance to Blnk's hosted Core using PostgreSQL database migration tools. Or migrate your data from Blnk Cloud to a self-hosted Core instance."
og:title: "Migrate your instance in or out of Blnk Cloud | Blnk Cloud Guide"
og:description: "Step-by-step guide to migrate your data from self-hosted Core to Blnk's hosted Core instance or vice versa"
---
...
<Frame caption="Go to Settings > Migration, select a deployment and direction, paste your PostgreSQL URL, then start the migration">
<img src="/cloud/img/instances/migration-page.gif" alt="Migration page showing the Data Migration form and Migration history table" className="rounded-lg" />
</Frame>
...
<RelatedTopics
  items={[
    ...
    { title: "Branching", href: "/cloud/instances/branching" },
  ]}
/>

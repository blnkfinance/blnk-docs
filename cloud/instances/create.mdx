...
<Steps>
  <Step title="Create an instance on Cloud">
    ...
    <img src="/cloud/img/instances/instance-settings-page.gif" alt="Settings > Instances page showing the Connect new instance button" className="rounded-lg" />
    </Frame>
  </Step>
  ...
  <Step title="Set up the Query Agent">
    ...
    1. To get your `CONNECTION_KEY`: 
        ...
        <Frame caption="Copy your connection key from the Query Agent setup details page">
        <img src="/cloud/img/instances/connection-key-details.gif" alt="Instance details page showing where to find the connection key" className="rounded-lg" />
        </Frame>
  ...
  <Step title="Verify connection">
    ...
    <Frame caption="Your instance shows Connected when the Query Agent is running">
    <img src="/cloud/img/instances/query-agent-setup-details.gif" alt="Query Agent setup guide showing Connected status with a green indicator" className="rounded-lg" />
    </Frame>
  </Step>
</Steps>

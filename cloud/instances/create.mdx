...
<Steps>
  <Step title="Create an instance on Cloud">
    ...
    <img src="/cloud/img/instances/instance-settings-page.gif" alt="Settings → Instances page showing the Deploy an instance button" className="rounded-lg" />
    </Frame>
  </Step>
  ...
  <Step title="Set up the Query Agent">
    Copy the Docker command from your Query Agent setup page and run it on the machine that hosts your Core database.

...
<Steps>
  <Step title="Create an instance on Cloud">
    ...
    <img src="/cloud/img/instances/managed-instance-open-form.gif" alt="Settings → Instances page showing the Deploy an instance button" className="rounded-lg" />
    </Frame>
  </Step>
  <Step title="Provide instance details">
    ...
    <img src="/cloud/img/instances/instance-creation-form.gif" alt="Instance creation form with instance name, Core URL, and secret key fields" className="rounded-lg" />
    </Frame>
  ...
  <Step title="Set up the Query Agent">
    ...
    <img src="/cloud/img/instances/query-agent-copy-command.gif" alt="Opening View setup details and copying the Docker command from the Query Agent setup page" className="rounded-lg" />
    </Frame>
...
<img src="/cloud/img/instances/remove-instance.gif" alt="Deleting a self-hosted instance from the actions menu with the confirmation modal" className="rounded-lg" />
</Frame>

...
To learn more about how transactions work in Blnk, see our [Transactions | Developer Docs](https://docs.blnkfinance.com/transactions/introduction).
...
<img src="/cloud/img/transactions/create-transaction-form.png" alt="Create transaction form with all required fields" className="rounded-lg" />

1. Click **Create transaction** in the top-right corner of the **Transactions** table or press **⌥ + T** (`Alt + T` for Windows).
...
3. Blnk Cloud automatically generates a reference number for the transaction.
4. Click **Create transaction** to complete.
...
<Warning>
  ...
  Learn more in our [Precision | Developer Docs](https://docs.blnkfinance.com/transactions/precision).
</Warning>
...
<img src="/cloud/img/transactions/overdraft-option.png" alt="Apply overdraft checkbox option" className="rounded-lg" />

> To apply an overdraft, check the **Apply overdraft** option before creating the transaction.
...
<img src="/cloud/img/transactions/inflight-option.png" alt="Apply inflight checkbox option" className="rounded-lg" />

> To apply inflight, check the **Apply inflight** option before creating the transaction.
...
>
> 1. Select **Schedule transaction** at the bottom of the transaction form.
...
- **Effective date:** The date and time the transaction was created.

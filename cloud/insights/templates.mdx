...
Use this when you need a count of wallets per currency, plus total balance in minor units. Balance fields are integers (cents, satoshi), and balances do not include `precision`. It helps you see how your portfolio is split across currencies.

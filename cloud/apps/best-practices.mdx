...
- Use the [Proxy API](/cloud/reference/proxy-api) for Core actions, the [Filters API](/cloud/reference/filters-api) for live reads, and [Create new query](/cloud/reference/create-new-query) for historical SQL. Use alerts endpoints for alert features, not the proxy.

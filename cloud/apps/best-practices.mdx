...
- Use the [Proxy API](/cloud/reference/proxy-api) for Core actions and [Create new query](/cloud/reference/create-new-query) for historical SQL. Use alerts endpoints for alert features, not the proxy.

...
- Use the [Proxy API](/cloud/proxy/proxy-api) for Core actions, the [Filters API](/cloud/proxy/filters-api) for live reads, and the [Data Lake API](/cloud/reference/data-lake-api) for historical SQL. Use alerts endpoints for alert features, not the proxy.

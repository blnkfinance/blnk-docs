...
## Pin an app for your team

Pinning is for the **whole organization**, not only the person who clicks it. Everyone in the workspace sees the same pinned apps in the sidebar.

Do this from the **Apps** library list (you do not need to open app details):

<Steps>
  <Step title="Open Apps">
    Open **Apps** from the bottom of the sidebar.
  </Step>
  <Step title="Pin for the team">
    On the installed app card, click the pin icon. The tooltip is **Pin to sidebar for your team**.

    Cloud confirms with a toast. Pinned apps sort to the top of the library and show in the sidebar for your team.
  </Step>
</Steps>

To take it off the sidebar for everyone, click the pin again. The tooltip is **Unpin from sidebar for your team**.

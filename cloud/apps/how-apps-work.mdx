...
| :-- | :-- | :-- |
| Proxy API | `/proxy/...` | Call any Core endpoint through Cloud (GET, POST, PUT, DELETE). |
...
<img src="/cloud/img/apps/how-apps-request-flow.png" alt="Request flow showing the app backend calling Cloud proxy, data lake, and alerts endpoints, which forward to Blnk Core or Cloud features" className="rounded-lg" />
</Frame>

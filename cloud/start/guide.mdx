...
<Steps>
  ...
  <Step title="Select a Cloud plan">
    ...
    - **Starter:** Sandbox environment for development and testing. Build and validate your money movement and ledger logic before going to production.

    - **Production:** Run your ledger and money movement in production. Includes everything in Starter plus automated backups, SLA & incident support, and 24/7 support.

    <img src="/cloud/img/start/cloud-plans.png" alt="Comparison of Blnk Cloud plans: Starter and Production" className="rounded-lg" />

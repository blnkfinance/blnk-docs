...
<Tip>
You can create API keys in [Settings > API Keys](/cloud/reference/api-keys/#create-an-api-key) in your Blnk dashboard.
</Tip>
</Tab>
...
<Tip>
You can create OAuth clients in [Settings > API Keys](/cloud/reference/oauth/#create-an-oauth-client) in your Blnk dashboard. Select `OAuth` as the type when creating.
</Tip>
</Tab>
</Tabs>
</Step>

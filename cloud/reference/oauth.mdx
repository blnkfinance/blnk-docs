...
For third-party integrations, you'll need an access token to interact with the user's Cloud workspace via the [Cloud Proxy](/cloud/reference/proxy-api) and [Create new query](/cloud/reference/create-new-query).
...
Include your access token in the `X-blnk-key` header for Cloud API requests:

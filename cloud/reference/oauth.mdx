...
For third-party integrations, you'll need an access token to interact with the user's Cloud workspace via the [Cloud Proxy](/cloud/reference/proxy-api), [Filters API](/cloud/reference/filters-api), and [Data Lake API](/cloud/reference/data-lake-api).

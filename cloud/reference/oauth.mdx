...
For third-party integrations, you'll need an access token to interact with the user's Cloud workspace via the [Cloud Proxy](/cloud/reference/proxy-api), [Filters API](/cloud/reference/filters-api), and [Create new query](/cloud/reference/create-new-query).
...
<CardGroup cols={2}>
<Card title="Proxy API documentation" icon="ethernet-port" href="/cloud/reference/proxy-api">
Create ledger records via Cloud APIs.
</Card>

<Card title="Filters API documentation" icon="list-filter" href="/cloud/reference/filters-api">
Filter live ledger data.
</Card>

<Card title="Data lake API documentation" icon="water" href="/cloud/reference/create-new-query">

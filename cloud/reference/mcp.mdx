...
AI assistants such as Cursor, Claude Desktop, and ChatGPT connect to this endpoint, authenticate with Blnk Cloud credentials, and call tools to read or write ledger data.

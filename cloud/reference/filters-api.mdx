...
Unique identifier of the Blnk Core instance to query. Required on every Filters API request. Get it from [list instances](/cloud/reference/list-instances) (`instance_...`), not from `deployment_id`.
</ParamField>
...
<RelatedTopics
  items={[
    { title: "Filters API guide", href: "/cloud/proxy/filters-api" },

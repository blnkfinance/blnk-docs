...
icon: "book-open"
description: "Browse Blnk Cloud REST endpoints for OAuth authentication, Deployments, Billing, Proxy, Data, Filters, Alerts, and MCP integrations."
og:title: "Cloud API Reference Overview | Blnk Cloud Guide"
og:description: "Browse Blnk Cloud REST endpoints for OAuth authentication, Deployments, Billing, Proxy, Data, Filters, Alerts, and MCP integrations."
---
...
9. For other direct requests (alerts, MCP), Blnk Cloud processes the request and returns the response to your app.
...
<CardGroup cols={2}>
  ...
  <Card title="Billing API" icon="credit-card" href="/cloud/reference/get-billing-org">

...
icon: "book-open"
description: "Browse Blnk Cloud REST endpoints for OAuth authentication, Deployments, Proxy, Data, Filters, Alerts, and MCP integrations."
og:title: "Cloud API Reference Overview | Blnk Cloud Guide"
og:description: "Browse Blnk Cloud REST endpoints for OAuth authentication, Deployments, Proxy, Data, Filters, Alerts, and MCP integrations."
---
...
8. For other direct requests (alerts, MCP), Blnk Cloud processes the request and returns the response to your app.

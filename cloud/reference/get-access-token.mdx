...
OAuth client ID and client secret as HTTP Basic auth. Use `-u "YOUR_CLIENT_ID:YOUR_CLIENT_SECRET"` in cURL, or `Authorization: Basic base64(client_id:client_secret)`.
</ParamField>

...
description: "Retrieve alerts. Omit the alert ID to fetch all alerts, or include it to retrieve a specific alert."
---
...
<RelatedTopics
  items={[
    ...
    { title: "Update alert", href: "/cloud/reference/update-alert" },
  ]}
/>

...
<RequestExample>
```bash cURL
curl -X POST 'https://api.cloud.blnkfinance.com/alerts/flag/bln_5ce86029-3c2e-4e2a-aae2-7fb931ca4c4f' \
...
<ResponseField name="affected_balances" type="array">
Array of balance IDs affected by this alert.
</ResponseField>

<ResponseField name="affected_identities" type="array">
Array of identity IDs affected by this alert.
</ResponseField>

<ResponseField name="affected_transactions" type="array">

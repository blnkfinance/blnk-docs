...
```java Java wrap
ApiResponse<JsonNode> response = blnk.identity().tokenizeField(
    "idt_3b63c8da-af29-4cc3-ad38-df17d87456e6",
    "EmailAddress");
```
</CodeGroup>
...
```java Java wrap
ApiResponse<JsonNode> response = blnk.identity().getTokenizedFields("idt_3b63c8da-af29-4cc3-ad38-df17d87456e6");
```
</CodeGroup>
...
```java Java wrap
ApiResponse<JsonNode> response = blnk.identity().detokenizeField(
    "idt_3b63c8da-af29-4cc3-ad38-df17d87456e6",
    "EmailAddress");
```
</CodeGroup>

...
To create a balance connected to an identity, include the `identity_id` attribute in the request body of the **create-balance** endpoint. 

The `identity_id` is the unique identify of the identity you want to associate with the balance. 

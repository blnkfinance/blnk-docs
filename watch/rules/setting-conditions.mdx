...
| `day_of_week(created_at)` | Weekday: 0 = Sunday, 6 = Saturday. With `in`, you can use day names | `day_of_week(created_at) in (0, 6)` or `day_of_week(created_at) in ("Saturday", "Sunday")` |

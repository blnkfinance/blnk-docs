...
<CtaCallout
  title="Need help with Blnk Watch?"
  href="https://blnkfinance.com/contact/us?utm_source=blnk_docs&utm_medium=documentation&utm_campaign=watch%2Fquick-start"
...
<CardGroup cols={2}>
<Card title="Changelog" icon="scroll-text" href="/changelog/blnk-watch">
Watch releases and version history.
</Card>

<Card title="How Watch works" icon="brain" href="/watch/mental-model">
Evaluation workflow and verdicts.
</Card>
</CardGroup>
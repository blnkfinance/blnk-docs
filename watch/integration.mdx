---
sidebarTitle: "Getting data into Watch"
icon: "puzzle"
title: "Getting Data into Watch"
...
Register the hook in Core using [transaction hooks](/webhooks/transaction-hooks) - you can use a PRE or POST hook. 

Point the hook URL to Watch's `/blnkwebhook` endpoint:

```bash Register Watch hook in Blnk Core wrap

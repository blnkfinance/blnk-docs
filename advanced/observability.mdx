...
This guide helps you choose the right signal for a problem, connect Blnk to Blnk Cloud or your own monitoring stack, and verify that data is flowing. 
...
Once connected, your Core instance sends logs, traces, and metrics to your Cloud workspace so you can investigate incidents and track health where you manage your instance.
...
<Step title="Confirm data is flowing">
  ...
  It may take a few minutes for the first data to show up. Logs, traces, and metrics from both the server and workers appear in Cloud.
  ...
  <Frame>
  <img src="/cloud/img/monitoring/cloud-metrics.png" alt="Blnk Cloud monitoring workspace showing Blnk metrics over time" />
  </Frame>
...
Export traces, metrics, and logs to Jaeger, Prometheus, Grafana, OpenTelemetry Collector, Datadog, or any stack you already operate. 

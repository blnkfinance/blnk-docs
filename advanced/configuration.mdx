...
To successfully [run your Blnk server](../home/install) and start to use Blnk, you need to set your configuration settings to make sure things works properly.

...
- a stored API key
    ...
    <Card title="API keys" icon="key" href="/advanced/secure-blnk#api-keys">
      Custom permissions for secure requests.
    </Card>
...
2. As the HMAC signing secret for outgoing webhooks and hook callbacks.
    ...
    <Note>
    Starting in **0.14.3**, hook management endpoints (create, update, view, list, and delete) accept only the master key. See [Manage hooks](/hooks/create-hooks).
    </Note>

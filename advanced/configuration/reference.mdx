...
This page is the complete reference for Blnk configuration. It lists every supported setting and shows the runtime default value where applicable. 

Fields with no default are left blank.

...
<Note>
`server.ssl` / `BLNK_SERVER_SSL` is honoured from **0.15.4**. Through 0.12.x the flag worked. From 0.13.0 through 0.15.3 it was ignored. See [HTTPS (`server.ssl`)](/advanced/configuration/server-security#https-serverssl).
</Note>

...
| `BLNK_REDIS_CONN_MAX_IDLE_TIME` | How long a pooled connection may sit idle before Blnk discards it. Use Go duration format (`2m`). From 0.15.5. | `2m`    |
...
How long a pooled Redis or Asynq connection may sit idle before Blnk discards it instead of reusing it. The default is `2m`. Leave it unset unless your Redis, Valkey, or proxy idle timeout is shorter than that.

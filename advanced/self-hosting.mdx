...
<Tip>
  If you want the simplest path to production, use [Blnk Cloud](https://cloud.blnkfinance.com/?utm_source=blnk_docs&utm_medium=documentation&utm_campaign=advanced%2Fself-hosting) instead of managing your own infrastructure.
</Tip>

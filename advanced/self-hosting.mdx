...
icon: "server"
description: "Learn how to self-host Blnk on your infrastructure."
...
import SupportHelp from "/snippets/support-help.mdx";

Blnk provides two paths for self-hosting Blnk: 

1. **Open-source license:** Allows you to self-host the open-source Core for free. 
2. **Production license:** Allows you to self-host the entire Blnk stack, including the Core, Cloud dashboard, and Watch.

In this guide, we will cover how to run Blnk on your own based on your license type.
...
<Tabs>
  <Tab title="Open-source license">
    ...
    There are two ways to self-host the open-source Blnk Core: via [Docker](#using-docker) or [Kubernetes](#using-kubernetes).
    ...
    <Steps>
      ...
      <Step title="Start deployment">
        Run these commands in your terminalto start and validate your deployment:

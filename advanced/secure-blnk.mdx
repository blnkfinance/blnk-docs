...
```bash
curl -X POST -H "X-Blnk-Key: your_strong_secret_key" -H "Content-Type: application/json" \
-d '{
  "name": "Service Account",
  "owner": "service_name",
  "scopes": ["ledgers:read", "balances:write"],
  "expires_at": "2026-03-11T00:00:00Z"
}' https://yourdomain.com:5001/api-keys
```

#### Use the API key

```bash
curl -H "X-Blnk-Key: your_api_key" https://yourdomain.com:5001/ledgers
```

...
The master key is the `secret_key` from your configuration. Unlike [scoped API keys](/api-keys/overview), it is not bound to an owner or scopes, and it can call any endpoint on the server.

...
| `GEN_PAYLOAD_TOO_LARGE` | 413 | Request body exceeds the allowed size, including reconciliation file uploads |
...
| `ACC_GENERATION_FAILED` | 500 | Account number generation from the configured HTTP service failed |

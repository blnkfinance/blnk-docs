...
This is the Blnk Core configuration we used. Every shape on this page ran against it.
...
**Contention does not slow down acceptance.** The four numbers sit within 6 percent of each other, **around 260,000 TPM**, or roughly 4,300 requests per second. Accepting a transaction writes a queued record and returns. 

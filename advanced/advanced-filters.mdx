...
"og:title": "Advanced Filtering • Blnk Developer Documentation"
...
5. **Use Search API for complex queries**: For advanced operations like grouping, joins, or full-text search, consider using the [Search API](/search/overview) instead.

...
3. The [Blnk CLI](/blnk-cli/install) installed or a connected [Blnk Cloud](https://cloud.blnkfinance.com/?utm_source=blnk_docs&utm_medium=documentation&utm_campaign=backup%2Fcharge-card) workspace to view your ledger data.
...
curl -X POST http://localhost:5001/transactions \
  ...
  -d '{
    ...
    "destination": "<customer-card_balance_id>",

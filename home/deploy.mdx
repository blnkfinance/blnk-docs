...
We recommend connecting to Blnk Cloud to set up monitoring for your Core in less than 5 minutes. See how to: [Quick Start: Observability in Blnk](/advanced/observability#quick-start).

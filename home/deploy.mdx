...
<Steps>
  ...
  <Step title="Deploy the server">
    ...
    Point your project's public URL to port `5001` so you can reach the Blnk server from outside the project.
  ...
  <Step title="Deploy the worker">
    ...
    The worker does not need a public HTTP port. Deploy it after the server is healthy.
  </Step>

...
import DockerImage from "/snippets/docker-image.mdx";
...
To upgrade Core safely across versions, see [Upgrade Blnk Core](/changelog/upgrade).
...
<Steps>
  ...
  <Step title="Create a 'docker-compose.yml' file">
    ...
    services:
      server:
        image: ${BLNK_IMAGE:-ghcr.io/blnkfinance/blnk:0.15.3}
...
<Step title="Add Jaeger and Prometheus services">
  ...
  ```yaml docker-compose.yaml {13,18-19,28-29,32-33,37-49,51-62} wrap
  version: "3.8"
...
<RelatedTopics
  items={[
    ...
    { title: "Backup to disk", href: "/advanced/backup-disk" },
  ]}
/>

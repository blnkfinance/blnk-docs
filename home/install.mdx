...
This is your guide to getting started with Blnk, pronounced as `/blank/`. If you are new to Blnk or [open-source fintech developer tools](https://blnkfinance.com/?utm_source=blnk_docs&utm_medium=documentation&utm_campaign=home%2Finstall), this is where you should start.

...
<CardGroup>
  <Card title="1. Launch Blnk" href="#1-install-blnk-on-your-machine" icon="download"></Card>
  <Card title="2. Create your first transaction" href="#3-create-your-first-transaction" icon="arrow-left-right"></Card>
</CardGroup>

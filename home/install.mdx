...
<Tip>Since this is your first transaction, it means the participating balances will be equal to 0. To ensure that the transaction is applied successful, ensure that overdrafts is enabled as highlighted above.</Tip>

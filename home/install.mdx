...
"og:description": "Discover Blnk, the open-source financial backend for building fintech. Accurately record transactions and scale your fintech product reliably with Blnk."
---
...
[Read our full guide on how to use the Blnk CLI](../guides/blnk-cli)
...
To view your ledgers, use the following command in your terminal:
...
To view your balances, use the following command in your terminal:
...
To view your transactions, use the following command in your terminal:

...
<CardGroup cols={2}>
  <Card title="Ledgers" icon="book" iconType="duotone" href="/ledgers/introduction">
    organize your ledger according to your business/application needs.
  </Card>
  
  <Card title="Balances" icon="wallet" iconType="duotone" href="/balances/introduction">
    Create and manage balances for wallets, accounts, and any store of value.
  </Card>
  
  <Card title="Transactions" icon="messages-dollar" iconType="duotone" href="/transactions/introduction">
    Create any transaction workflow with Blnk.
  </Card>
  
  <Card title="Reconciliations" icon="object-union" iconType="duotone" href="/reconciliations/overview">
    Match balances and transactions in your ledger with external sources.
  </Card>
  
  <Card title="Identities" icon="user" iconType="duotone" href="/identities/introduction">
    Create, manage and link identities securely to balances.
  </Card>
  
  <Card title="Hooks" icon="link" iconType="duotone" href="/hooks/overview">

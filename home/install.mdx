---
title: "Installing Blnk"
sidebarTitle: "Quick start"
description: "Learn how to install and set up your ledger."
icon: "rocket-launch"
"og:title": "Installing Blnk • Blnk Developer Documentation"
"og:description": "Learn how to install and set up your ledger."
---
...
Ledger balances (or balances for short) are used to represent store of value in a fintech application, e.g., [wallet](/resources/examples/multicurrency), [account](/resources/examples/savings), [card balance](/resources/examples/virtual-cards), etc. They represent the source or destination of a transaction record.
...
<Tip>
Since this is your first transaction, it means the participating balances will be equal to 0. To ensure that the transaction is applied successful, ensure that overdrafts is enabled as highlighted above.
...
<CardGroup>
  <Card title="Multicurrency wallets" iconType="duotone" icon="money-bill-transfer" href="/resources/examples/multicurrency"></Card>

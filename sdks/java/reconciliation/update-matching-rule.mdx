...
| `criteria` | `List<Map<String, Object>>` | Full replacement array of match criteria. |
...
| `criteria` | `List<Map<String, Object>>` | The updated match criteria stored for the rule. |

...
| `criteria` | `List<Map<String, Object>>` | Array of match criteria. Each entry sets how one field is compared. |
...
| `criteria` | `List<Map<String, Object>>` | The match criteria stored for the rule. |

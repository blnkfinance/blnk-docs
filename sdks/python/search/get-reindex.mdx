...
description: "Poll the progress of a Typesense reindex with the Python SDK."
---

import NeedHelp from "/snippets/need-help.mdx";

Use `blnk.search.get_reindex_status` to check search reindex progress.

<Steps>
<Step title="Call the method">

```python blnk.search.get_reindex_status wrap

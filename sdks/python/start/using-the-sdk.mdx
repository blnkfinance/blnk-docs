---
title: "Using the SDK"
description: "Configure authentication, timeouts, retries, and logging for the Python SDK."
...
<Info>
Configurable client options ship in v1.3.0. See the [Changelog](/changelog/blnk-py) before upgrading.
</Info>
...
blnk = blnk_init(
    "",
    BlnkClientOptions(base_url="http://localhost:5001"),
)
```
...
By default, the SDK logs internal events through a built-in logger that writes to the console with `INFO:`, `ERROR:`, and `DEBUG:` prefixes.

...
| `filter` | [Search via DB](/reference/search-db) | Structured Postgres filters |
| `startReindex` | [Start reindex](/reference/start-reindex) | Rebuild Typesense from the database |
| `getReindexStatus` | [Get reindex status](/reference/get-reindex) | Poll reindex progress |

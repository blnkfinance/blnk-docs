...
description: "Run full-text search across your ledger data with the TypeScript SDK."
---
...
```typescript blnk.Search.search wrap
...
<RelatedTopics
  items={[
    ...
    { title: "Multi-search", href: "/sdks/typescript/search/multi-search" },
  ]}
/>

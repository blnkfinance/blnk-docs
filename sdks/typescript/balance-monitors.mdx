...
| `list` | [Get balance monitor](/reference/get-balance-monitor) | List monitors on the instance |
| `update` | [Edit balance monitor](/reference/edit-balance-monitor) | Change monitor condition or settings |

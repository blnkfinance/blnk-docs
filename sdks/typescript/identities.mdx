...
| `getTokenizedFields` | [Get tokenized fields](/reference/get-tokenized-fields) | List fields currently tokenized |
| `tokenizeField` | [Tokenize field](/reference/tokenize-field) | Tokenize one PII field |
| `tokenize` | [Tokenize identity](/reference/tokenize-identity) | Tokenize multiple PII fields |
| `detokenizeField` | [Detokenize field](/reference/detokenize-field) | Read one tokenized field's original value |
| `detokenize` | [Detokenize identity](/reference/detokenize-identity) | Detokenize multiple fields (or all) |
...
`blnk.Identity.getTokenizedFields` returns the list of fields currently tokenized on an identity.
...
See [Get tokenized fields](/reference/get-tokenized-fields) for response shape and validation.

---

## Tokenize one field

`blnk.Identity.tokenizeField` tokenizes a single field. Pass a **PascalCase** struct name in the path (`FirstName`, `EmailAddress`).
...
See [Tokenize field](/reference/tokenize-field) for response shape and validation.

---

## Detokenize one field

`blnk.Identity.detokenizeField` returns the original value of one tokenized field without changing the stored identity record.
...
See [Detokenize field](/reference/detokenize-field) for response shape and validation.

---

## Detokenize multiple fields

`blnk.Identity.detokenize` returns original values for the fields you specify. Pass an **empty** `fields` array to detokenize all currently tokenized fields.
...
See [Detokenize identity](/reference/detokenize-identity) for request fields, response shape, and validation.

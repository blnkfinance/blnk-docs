...
On success, Core returns the updated monitor. Fetch the monitor with [get balance monitor](/sdks/go/ledger-balances/get-balance-monitor) to verify the new condition and webhook URL.
...
| `condition` | `object` | Updated threshold rule. |

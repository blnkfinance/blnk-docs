...
| `Status` | `blnkgo.PryTransactionStatus` | Transaction [status](/transactions/transaction-lifecycle#statuses) (for example `QUEUED`, `APPLIED`, `INFLIGHT`). |

...
3. `logger`: Optional object implementing `BlnkLogger` (`info`, `error`, optional `debug`). Defaults to `CustomLogger` when omitted.
...
Escrow, savings, cards, reconciliation, and more
</Card>

...
The [Historical Balances](/reference/historical-balances) endpoint allows users to retrieve the balance for a specific account (identified by :id) at a particular historical point in time, specified by the timestamp parameter.

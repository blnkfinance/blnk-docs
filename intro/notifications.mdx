...
Blnk sends webhook notifications for three main events in your Blnk Ledger.
...
3. **`balance.monitor`:** This event is sent when a balance monitor has been triggered and the monitoring conditions set have been met. **See also →** [Balance monitoring](/ledger/tutorial/balance-monitoring).

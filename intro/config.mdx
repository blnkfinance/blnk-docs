...
description: ""
'og:title': 'Configure your Blnk server'
'og:description': 'sure your Blnk server runs flawlessly by setting up your configuration file (blnk.json). Learn what each setting controls and explore additional resources for managing notifications, security, and more.'
'article:publisher': 'Jerry Enebeli, Praise Philemon'
---

To successfully [run your Blnk server](run-blnk-server) and start to use Blnk, you need to set your configuration settings to make sure things works properly.

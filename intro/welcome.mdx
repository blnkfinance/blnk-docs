...
Blnk was designed for individuals and teams building financial applications — developers, product managers, etc. With Blnk, you can explore a better alternative to building financial applications in today's constantly evolving world. 
...
Blnk also makes it easy to collaborate with other internal and external departments who need access to your organization's financial data — settlements and reconciliation, transaction security, fraud prevention and AML, finance and accounting, and even management. It's 100% in your power to build the most transparent network of systems for your organization with Blnk.

## Our principles

Blnk wants to help you build great financial applications. We believe these principles make up the foundation of any great financial application today. Moreover, they also determine how committed a financial application is to customer safety and security, and the Blnk Ledger was designed with them in mind.

#### Accuracy and correctness

All financial data must [be accurate to the smallest unit](/ledger/tutorial/precision). Beyond ensuring trust within your organization and your users, paying a keen attention to detail to all of the activities happening in your financial application shows that you care about what you build and you build it for. And caring is the only way great products are built.
...
The best time to use Blnk was an hour ago; the next best time is right now. We've grouped the developer documentation into sections below for you to easily get set up and further understand what Blnk has in store for you.

You can also [join our growing Slack community](https://join.slack.com/t/blnk-ledger/shared_invite/zt-2fwdivkvm-zHW4F8lwtVsbIaPg~dyx9w) of other developers like you building financial applications across the world. Share your questions about getting started or find answers to a problem you can't solve.
...
<AccordionGroup>
	...
	<Accordion title="Explore advanced features">
		...
		2. [Process similar transactions at once.](/ledger/tutorial/multiple-sources)

...
description: "Learn how Blnk use transaction hashing for immutability."
icon: "hashtag"
"og:title": "Transaction hashing - Blnk"
"og:description": "How Blnk uses SHA-256 hashing to ensure transaction integrity. Understand hashing, verify transactions, and explore the security benefits it provides."
---

...
icon: "filter"
"og:title": "Filtering parameters in Search - Blnk" 
"og:description": "Unlock the power of Blnk Search! Filter ledger data with matching, negation, filtering numbers & dates, and combining conditions. Find what you need, fast!"
---

...
icon: "bullseye"
"og:title": "Transaction precision"
...
<Tip>
    We created an open source repository of all 151 fiat currencies and their respective precision values. See here: [blnk-assets](https://github.com/blnkfinance/blnk-assets)
</Tip>

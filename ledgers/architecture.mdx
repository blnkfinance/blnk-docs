...
Ledger architecture is how you set up and design your ledgers to work for your application. It is crucial to ensuring that your ledger is seamless and scaleable.
...
The Blnk Ledger is modeled after the folder-file system of many file managers. Just like file managers, how you arrange to your files (balances) in folders (ledgers) is dependent on how you want to group and find those files (balances). 
...
With this design, the organization can see the user's position in his application. They can compare how much the user has borrowed against how much is in their account, the number of transactions performed by the user, etc. 

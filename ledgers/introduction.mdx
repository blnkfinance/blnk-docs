...
<CardGroup>
  <Card title="Creating balances in the General Ledger" iconType="duotone" icon="abacus" href="/balances/internal-balances">
    Learn how to create and manage balances in the General Ledger.
  </Card>
  <Card title="Architecting your ledger" iconType="duotone" icon="sitemap" href="/ledgers/architecture">

...
<CardGroup>
  <Card title="Creating internal balances" icon="network" href="/balances/internal-balances"></Card>
  <Card title="Architecting your ledger" icon="layers" href="/ledgers/architecture"></Card>
</CardGroup>

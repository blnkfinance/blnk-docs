...
"og:title": "General Ledger • Blnk Developer Documentation"
...
<CardGroup>
  <Card title="Creating internal balances" icon="network" href="/balances/internal-balances">
    Organization-owned General Ledger balances.
  </Card>
...
<RelatedTopics
  items={[
    ...
    { title: "Architecture", href: "/ledgers/architecture" },

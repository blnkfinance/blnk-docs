...
| `facet_by` | Comma-separated list of fields to aggregate and count. [Learn more](/search/faceting) | No | `string` |
| `max_facet_values` | Maximum number of facet values to return per field. Default 10. [Learn more](/search/faceting) | No | `integer` |
...
| `facet_counts` | Aggregated counts for faceted fields. Only present when using `facet_by`. [Learn more](/search/faceting) | `array` |

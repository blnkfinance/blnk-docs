...
curl -X POST "http://YOUR_BLNK_INSTANCE_URL/search/transactions" \
  ...
  -d '{
    "q": "*",
    "filter_by": "description:payment && reference:ref_f482a1b3-6c2d-4e89-a17b-3d5e8f2a1c94"
  }'
```
...
results, resp, err := client.Search.SearchDocument(
    blnkgo.SearchParams{
        Q: "*",
        FilterBy: "description:payment && reference:ref_f482a1b3-6c2d-4e89-a17b-3d5e8f2a1c94",
    },
    blnkgo.Transactions,
)
```
...
ApiResponse<JsonNode> response = blnk.search().search(
    SearchParams.create()
        .q("*")
        .filterBy(
            "description:payment && reference:ref_f482a1b3-6c2d-4e89-a17b-3d5e8f2a1c94"),
    "transactions");
```
</CodeGroup>
...
ApiResponse<JsonNode> response = blnk.search().search(
    SearchParams.create()
        .q("*")
        .filterBy("amount:>1000 && balance:<=50000"),
    "transactions");
```
</CodeGroup>
...
ApiResponse<JsonNode> response = blnk.search().search(
    SearchParams.create()
        .q("*")
        .filterBy("status:[APPLIED, INFLIGHT] && currency:[USD, EUR]"),
    "transactions");
```
</CodeGroup>
...
ApiResponse<JsonNode> response = blnk.search().search(
    SearchParams.create()
        .q("*")
        .filterBy("status:=APPLIED && currency:=USD && amount:>1000"),
    "transactions");
```
</CodeGroup>
...
ApiResponse<JsonNode> response = blnk.search().search(
    SearchParams.create()
        .q("*")
        .filterBy("currency:!=USD && status:!=REJECTED"),
    "transactions");
```
</CodeGroup>
...
ApiResponse<JsonNode> response = blnk.search().search(
    SearchParams.create()
        .q("*")
        .filterBy("status:[APPLIED, INFLIGHT]"),
    "transactions");
```
</CodeGroup>
</Step>
...
ApiResponse<JsonNode> response = blnk.search().search(
    SearchParams.create()
        .q("*")
        .filterBy("amount:[1000..10000] && currency:=USD"),
    "transactions");
```
</CodeGroup>
</Step>
...
ApiResponse<JsonNode> response = blnk.search().search(
    SearchParams.create()
        .q("*")
        .filterBy("currency:[USD, EUR, GBP] && balance:>0"),
    "balances");
```
</CodeGroup>
</Step>

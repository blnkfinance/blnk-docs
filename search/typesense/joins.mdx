...
```json Response (all fields) {15-36}
{
  "facet_counts": [],
  "found": 144,
  "hits": [
...
```
```json Response (specific fields) {15-19}
{
  "facet_counts": [],
  "found": 144,
  "hits": [
...
{
  "q": "*",
  "filter_by": "$transactions(destination:=bln_5ce86029-3c2e-4e2a-aae2-7fb931ca4c4f)",

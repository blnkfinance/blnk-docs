...
description: "Run your reconciliation process."
api: "POST /reconciliation/start"
noindex: true
"og:title": "Start Reconciliation • Blnk API Reference"
---
...
<ParamField body="upload_id" type="string">
  Defines the unique ID of the file containing the external data to be reconciled. Used for [Batch Reconciliation](/reconciliations/overview#option-1-batch-reconciliation).
</ParamField>
...
```json 400
{
  "error": "matching_rule_ids is required",
  "error_detail": {
    "code": "RECON_MATCHING_RULES_REQUIRED",

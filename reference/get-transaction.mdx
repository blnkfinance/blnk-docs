...
<Tip>
When listing all transactions, you can use [advanced filter operators](/advanced/advanced-filters) to narrow down results by status, currency, amount, source, destination, and more.
</Tip>

...
<ParamField body="skip_queue" type="boolean">
  When `true`, it bypasses the default transaction queuing system and processes transactions directly. If the source has insufficient funds, see [Managing insufficient funds](/transactions/introduction#managing-insufficient-funds). See also: [Skip transaction queue](/transactions/introduction#skip-transaction-queue).
</ParamField>

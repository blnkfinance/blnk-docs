...
<ParamField body="amount" type="integer">
  Specifies the amount to be committed in the case of a partial commit. Learn more: [Partial commits for inflight transactions](/transactions/inflight/updating-inflight#partial-commits).
</ParamField>

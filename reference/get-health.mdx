...
Blnk runs the **server** and **worker** as separate processes. Each registers its own `GET /health` endpoint on a different port. Probe both processes in production.

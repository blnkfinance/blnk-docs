...
Just like the Blnk Ledger, Plugins are also open-source. You can develop your own plugins for your project, but we require you to publish it on the [Blnk Plugin public repository](https://github.com/blnkledger/plugins.git) to be able to run them on your project using the [Blnk CLI](blnk-cli).

<Info>
    We have published to sample plugins for you to test with:
    - Hello world
    - GBP balance converter
</Info>
...
You can find the name of the plugin file in the [Blnk Plugin public repository.](https://github.com/blnkledger/plugins.git)
...
<Steps>
    <Step title="Install the hello-world plugin">
        ...
        Warning: Plugin converter is not verified by Blnk. Use with caution.
        ```

...
Say a customer wants to receive 30000 from 3 people. Person A sends 10%, Person B sends 20000, and Person C sends the rest.

Here's a sample overview of their balance information:

| User | Balance ID | Expectation
| --- | --- | --- |
| Recipient | bln_92e4b9b6-0b85-4ef4-87a2-682c31500d38 | Will receive a total of 30000
| Person A | bln_f2073f6b-905a-4e3e-b5a2-8d1b3dc2fb7f | Will send 10% of 30000
| Person B | bln_64c50fb5-32d5-4f78-9f4a-e8b01aaf025d | Will send 20000
...
<Steps>
	<Step title="Define your transaction parameters">
		...
		- **Amount**: Total amount to be received by the recipient (30000).
	...
	<Step title="Initiate the transaction">
		...
		- `amount`: Total amount of money to be received **(float).**
...
| --- | --- | --- |
| Specific amount | Provide the specific amount of money to be sent | `"distribution": "20000"` - Means 20000 from the total amount should be sent

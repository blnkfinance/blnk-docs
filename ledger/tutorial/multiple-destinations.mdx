...
This enhances transaction transparency and traceability within your application by offering you and your team enhanced control over financial operations. By consolidating multiple sources into one single transaction, you can monitor and manage transactions more effectively, contextualize your transaction, and facilitate easier tracking and reconciliation.

**See also → [Managing multiple sources](/ledger/tutorial/multiple-sources).**

### How it works

Say a customer wants to sends 30,000 from their account balance to three people. They want 20% to go to Person A, 10000 to go to Person B, and the remaining amount to Person C. 

Here's a sample overview of their balance information:

| User | Balance ID | Expectation
| --- | --- | --- |
| Sender | bln_92e4b9b6-0b85-4ef4-87a2-682c31500d38 | Will send a total of 30000
| Person A | bln_f2073f6b-905a-4e3e-b5a2-8d1b3dc2fb7f | Will receive 20% of 30000
| Person B | bln_64c50fb5-32d5-4f78-9f4a-e8b01aaf025d | Will receive 10000
...
<Steps>
	<Step title="Define your transaction parameters">
		...
		- **Amount**: Total amount to be sent by the sender (30000),
	...
	<Step title="Initiate the transaction">
		...
		- `destinations`: Contains information about the destinations the money is being sent to. Each object within this array represents a destination and includes two required fields:
			...
			- `narration`: Short description of why the transaction is being initiated **(string).** It is optional.
	...
	<Step title="Send your request">
		...
		| --- | --- | --- | --- | --- |
		| ref_001adcfgf1 | NGN | 6000 | bln_92e4b9b6-0b85-4ef4-87a2-682c31500d38 | bln_f2073f6b-905a-4e3e-b5a2-8d1b3dc2fb7f
		| ref_001adcfgf2 | NGN | 10000 | bln_92e4b9b6-0b85-4ef4-87a2-682c31500d38 | bln_64c50fb5-32d5-4f78-9f4a-e8b01aaf025d
		| ref_001adcfgf3 | NGN | 14000 | bln_92e4b9b6-0b85-4ef4-87a2-682c31500d38 | bln_7d98dfe9-5c3e-4c9b-b96a-65f6d9f7b89b
...
| --- | --- | --- |
| Specific amount | Provide the specific amount of money to be received | `"distribution": "10000"` - Means 10000 from the total amount should be received

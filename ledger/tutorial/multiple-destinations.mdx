...
Say a customer wants to sends NGN 30,000 from their account balance to three people. They want 20% to go to Person A, NGN 10,000 to go to Person B, and the remaining amount to Person C. 

Here's a sample overview of their balance information:

| User | Balance ID | Expectation
| --- | --- | --- |
| Sender | bln_92e4b9b6-0b85-4ef4-87a2-682c31500d38 | Will send a total of NGN 30,000
| Person A | bln_f2073f6b-905a-4e3e-b5a2-8d1b3dc2fb7f | Will receive 20% of NGN 30,000
| Person B | bln_64c50fb5-32d5-4f78-9f4a-e8b01aaf025d | Will receive NGN 10,000
...
<Steps>
	<Step title="Define your transaction parameters">
		...
		| --- | ---
		| Amount| Total amount to be sent by the sender (NGN 30,000),
...
| --- | --- | --- |
| Specific amount | Provide the specific amount of money to be received | `"distribution": "10000"` - Means NGN 10,000 from the total amount should be received

...
- Use `GET` for simple searches with URL parameters.
...
<Steps>
	...
	<Step title="Provide your search parameters">
	...
	<Step title="You're good to go!">
		...
		<Note>The parameters inside the `document` object will match the same parameters that make up the respective data collection you specified.</Note>
	</Step>
</Steps>
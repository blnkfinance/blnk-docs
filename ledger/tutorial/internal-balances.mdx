...
>**Important to note:**
>
>When you post a transaction to a new internal balance, the balance is created with the same asset class specified in the transaction, e.g., in the example above, `@Revenue` is an USD internal balance.

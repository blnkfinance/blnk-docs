...
After you initiate a refund, Blnk creates a new transaction record with its own unique transaction `id`. You can use the [Get Transaction endpoint](/misc/get-transaction) to track the status of the refund. 

...
Refunds can only be sent back to the destination in the original transaction. You can't send a refund to a different destination, like another balance or external account.

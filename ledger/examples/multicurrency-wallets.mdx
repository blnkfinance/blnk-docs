---
title: Building multi-currency wallets with Blnk.
---
...
<Steps>
    <Step title="Creating a USD Ledger">
        ...
        **Response:**
        ...
        ```
        <Tip>
            **Developer Note:** Always store the `ledger_id` in your database. You'll need it for future operations related to this ledger.
        </Tip>
    </Step>
...
<Steps>
    <Step title="Creating a USD Wallet for Customer A">
        ...
        **Response:**
        ...
        ```
        <Tip>
            **Developer Note:** The `balance_id` is important. Always store this in your database and associate it with the customer. You'll use this `id` for all future transactions involving this wallet.
        </Tip>
    </Step>
...
In this example, we'll cover funding our wallets with actual cash received from the outside world or other apps (banks/wallets etc). This section introduces key concepts in Blnk like [General Ledgers](../tutorial/internal-balances), [Overdrafts](../tutorial/overdrafts), and [`meta_data`](../tutorial/record-a-transaction).
...
<Steps>
    <Step title="Funding Customer A's USD Wallet with $200.00">
        ...
        **Response:**
        ...
        <Tip>
            **Developer Note:** Always use the precision field to avoid floating-point arithmetic issues. For USD and EUR, a precision of 100 (representing cents) is typically used.
        </Tip>
    </Step>
    <Step title="Funding Customer A's EUR Wallet with 3500.50 EUR">
        ...
        ```
        <Tip>
            **Developer Note:** The principles explained for the USD transaction apply here as well. Always ensure you're using the correct precision and currency for each transaction.
        </Tip>
    </Step>
</Steps>
...
<Steps>
    <Step title="Transferring $70.32 from Customer A's USD Wallet">
        ...
        **Response:**
        ...
        <Tip>
            **Developer Note:** Always check the balance after a transaction to ensure it's updated correctly. Here's how you might do that.
    ...
    <Step title="Transferring 1470.49 EUR from Customer A's EUR Wallet">
        ...
        ```
        <Tip>
            **Developer Note:** Always ensure you're using the correct `balance_id` for the source wallet and the correct currency for each transaction.
        </Tip>
    </Step>
</Steps>
...
<CardGroup>
  ...
  <Card title="Understanding precision" icon="book-open-cover" href="/ledger/tutorial/precision">
	...
	<Card title="Applying rates" icon="book-open-cover" href="/ledger/tutorial/applying-rates">
		How to apply rates to your transactions
  </Card>
  <Card title="Record a transaction" icon="book-open-cover" href="../tutorial/record-a-transaction">

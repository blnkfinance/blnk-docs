...
description: How to use Blnk in a savings product.
---
...
Customers can fund their savings accounts. We'll use the [Inflight feature](../tutorial/inflight) to manage funding transactions.

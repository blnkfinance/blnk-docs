...
<Steps>
    ...
    <Step title="Draw a transaction flow for each activity">
        ...
        Another way to do this is to deliver the entire amount to the user's balance, and then debit the fees from the user. This flow would like this:
    ...
    <Step title="Use your map to define how you build">
        ...
        2. A new ledger should be created to group all user balances. Total funds being held by all users in the e-commerce application can easily be traced and computed.
        3. Use [multiple destinations](../tutorial/multiple-destinations) feature to process wallet funding and withdrawal in one API request.

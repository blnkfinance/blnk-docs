...
<Steps>
    ...
    <Step title="Here's how the transaction records look like">
        ...
        | --- | --- | --- | --- | --- | --- | --- | --- 
        | txn_171821872187 | ref_8728781718 | 300000 | NGN | bln_ebcd230f-6265-4d4a-a4ca-45974c47f746 | @CompanyRevenue | Invoice payment | 2024-04-23 12:32 UTC

        <Note>
            The amount was converted to its lowest unit (kobo, in this case) to ensure correctness when computing the balances. To learn more, read: [Understanding precision](../tutorial/precision).
        </Note>
    </Step>
</Steps>
...
| id | reference | amount | currency | source | destination | description | created_at |
| --- | --- | --- | --- | --- | --- | --- | --- 
| txn_171821872187 | ref_8728781718 | 300000 | NGN | bln_ebcd230f-6265-4d4a-a4ca-45974c47f746 | @World | Invoice payment | 2024-04-23 12:32 UTC

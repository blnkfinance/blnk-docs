...
>
>Because the double entry aims to be the source of truth for your financial records. When you say you received ₦3,000, the assumption is that someone else paid ₦3,000 to you. If you received ₦3,000 despite being paid ₦4,000, it becomes a case of fraud and dishonesty which are terrible for any business.
...
<Steps>
    ...
    <Step title="Here's how the transaction records look like">
        ...
        | --- | --- | --- | --- | --- | --- | --- | --- 
        | txn_171821872187 | ref_8728781718 | 3000 | NGN | [User A balance_id] | @CompanyRevenue | Invoice payment | 2024-04-23 12:32 UTC
    </Step>
</Steps>
...
| id | reference | amount | currency | source | destination | description | created_at |
| --- | --- | --- | --- | --- | --- | --- | --- 
| txn_171821872187 | ref_8728781718 | 3000 | NGN | [User A balance_id] | @World | Invoice payment | 2024-04-23 12:32 UTC

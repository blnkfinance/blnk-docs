...
<CodeGroup>
```bash cURL wrap
curl -X POST "http://YOUR_BLNK_INSTANCE_URL/reconciliation/matching-rules" \
...
rule, resp, err := client.Reconciliation.CreateMatchingRule(blnkgo.Matcher{
  ...
  Criteria: []blnkgo.Criteria{
    {Field: blnkgo.CriteriaFieldAmount, Operator: blnkgo.ReconciliationOperatorEquals, AllowableDrift: 0.01},
    {Field: blnkgo.CriteriaFieldCurrency, Operator: blnkgo.ReconciliationOperatorEquals},
    {Field: blnkgo.CriteriaFieldDate, Operator: blnkgo.ReconciliationOperatorEquals, AllowableDrift: 1800},
    {Field: blnkgo.CriteriaFieldReference, Operator: blnkgo.ReconciliationOperatorContains},
  },
})
```
</CodeGroup>

...
External data in reconciliation refers to any and all documents that hold records of your transaction activity outside of your system. In financial services, whenever you record a transaction in your ledger, there is always an equal and corresponding record of that transaction in an external document. 

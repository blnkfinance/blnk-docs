...
result, resp, err := client.Reconciliation.Run(blnkgo.RunReconData{
  ...
  MatchingRuleIDs:  []string{"rule_890bdbc4-467f-4670-8424-5667e41daf29", "rule_a1b2c3d4-5678-90ef-ghij-klmnopqrstuv"},
})
```
</CodeGroup>
...
const response = await blnk.Reconciliation.run({
  ...
  strategy: 'one_to_one',
  matching_rule_ids: ['rule_04c4a59e-08a1-423b-bfae-48feebe16473'],
});
```
...
result, resp, err := client.Reconciliation.Run(blnkgo.RunReconData{
  ...
  MatchingRuleIDs: []string{"rule_04c4a59e-08a1-423b-bfae-48feebe16473"},
})
```
</CodeGroup>

...
1. [Upload external data](#1-upload-external-data): Import external data from payment processor reports and bank statements, and prepare them for reconciliation.
2. [Set matching rules](#2-set-matching-rules): Define how transactions should be compared and matched.
3. [Define reconciliation strategies](#3-define-reconciliation-strategies): Choose what type of reconciliation strategy you want to apply.

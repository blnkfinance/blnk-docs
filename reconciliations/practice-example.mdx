...
rule, resp, err := client.Reconciliation.CreateMatchingRule(blnkgo.Matcher{
  ...
  Criteria: []blnkgo.Criteria{
    {Field: "amount", Operator: blnkgo.ReconciliationOperatorEquals},
    {Field: "currency", Operator: blnkgo.ReconciliationOperatorEquals},
    {Field: "reference", Operator: blnkgo.ReconciliationOperatorEquals},
  },
})
```
</CodeGroup>
...
const response = await blnk.Reconciliation.run({
  upload_id: 'upload_0cd4a87d-544c-4b7e-9232-f36e79631c32',
  strategy: 'one_to_one',
  matching_rule_ids: ['rule_3d5ae6d4-6722-40c5-ac4b-0bd66ab7d363'],
});
```
...
result, resp, err := client.Reconciliation.Run(blnkgo.RunReconData{
  ...
  MatchingRuleIDs:  []string{"rule_3d5ae6d4-6722-40c5-ac4b-0bd66ab7d363"},
})
```
</CodeGroup>

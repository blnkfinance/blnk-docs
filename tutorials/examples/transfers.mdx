...
transaction, resp, err := client.Transaction.Create(blnkgo.CreateTransactionRequest{
    ParentTransaction: blnkgo.ParentTransaction{
        PreciseAmount: big.NewInt(15000),
        Precision: 100,
        Reference: "ref-0-07",
        Description: "Payment to ExternalProvider",
        Currency: "USD",
...
```json Response
{
    ...
    "rate": 0,
    "precision": 100,
    "transaction_id": "txn_7f8a9b1c-2d3e-4a5b-9c0d-1e2f3a4b5c6d",
    "parent_transaction": "",
    "source": "bln_e39a239a-a6ca-4509-b0d9-29dcc5630f8a",
    "destination": "@external-provider",
    "reference": "ref-0-07",
...
function findTransactionId(providerReference) {
  ...
  return "txn_7f8a9b1c-2d3e-4a5b-9c0d-1e2f3a4b5c6d";
}
...
Refund processed successfully: {"refund_id":"rfd_1a2b3c4d-5e6f-4a7b-8c9d-0e1f2a3b4c5d","transaction_id":"txn_7f8a9b1c-2d3e-4a5b-9c0d-1e2f3a4b5c6d","status":"APPLIED","amount":150.00,"currency":"USD","reason":"Payment verification failed","created_at":"2024-07-05T10:30:15.123456789Z","meta_data":{"failed_verification_code":"VERIF-001","provider_reference":"ext-pay-123456"}}
```
...
```bash cURL wrap
curl -X POST 'http://localhost:5001/transactions' \
  -H 'X-Blnk-Key: your-blnk-api-key-here' \
  -H 'Content-Type: application/json' \
  -d '{
...
expiresAt, _ := time.Parse(time.RFC3339, "2024-02-03T12:38:19Z")
transaction, resp, err := client.Transaction.Create(blnkgo.CreateTransactionRequest{
    ParentTransaction: blnkgo.ParentTransaction{
...
ApiResponse<JsonNode> response = blnk.transactions().create(
    CreateTransactions.create()
        ...
        .destination("bln_ebcd230f-6265-4d4a-a4ca-45974c47f746")
        .inflight(true)
        .inflightExpiryDate("2024-02-03T12:38:19Z")
        .metaData(Map.of(
            "provider_reference", "ext-pay-123456",
            "customer_id", "1234",
            "verification_status", "PENDING"
...
async function partialCommitInflightTransaction(transactionId, amountToCommit) {
  try {
    const response = await axios.post(`http://localhost:5001/transactions/${transactionId}/inflight`, {
      status: "commit",
      precise_amount: Math.round(amountToCommit * 100)
    }, {
      headers: {
        'X-Blnk-Key': 'your-blnk-api-key-here',
        'Content-Type': 'application/json'

...
ApiResponse<JsonNode> response = blnk.ledgerBalances().create(
    CreateLedgerBalance.create()
        ...
        .identityId("<identity-id>")
        .currency("USD")
        .metaData(Map.of("name", "Xavier Woods")));
```
...
<img src="/images/tutorials/ai-billing/wallet-topup-map.png" className="rounded-xl" alt="Money movement map for funding a customer's wallet" />
...
<RelatedTopics
  items={[
    ...
    { title: "Metadata", href: "/metadata/overview" },

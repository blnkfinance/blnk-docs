...
For this tutorial, we’ll use the Blnk TypeScript SDK for the implementation. If you prefer, you can also refer to the API documentation for details on the available endpoints.
...
You can use the same internal balance to represent external withdrawal destinations to ensure it is balanced out, or you can allocate a separate internal balance specifically for withdrawals.

...
```
```bash cURL
curl --location 'http://localhost:5001/ledgers' \
...
```
```bash cURL
curl --location 'http://localhost:5001/identities' \
--header 'Content-Type: application/json' \
--header "Authorization: Bearer YOUR_API_KEY" \
--data '{
    "identity_type": "individual",
...
```
```bash cURL
curl --location 'http://localhost:5001/balances' \
--header 'Content-Type: application/json' \
--header "Authorization: Bearer YOUR_API_KEY" \
--data '{
...
```
```bash cURL
curl --location 'http://localhost:5001/transactions' \
--header 'Content-Type: application/json' \
--header "Authorization: Bearer YOUR_API_KEY" \
--data '{
    "amount": 1000,

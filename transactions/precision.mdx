...
The `amount` field supports up to 15 digits. Exceeding this may cause rounding errors or truncation; switch to `precise_amount` for accuracy with larger values.
</Warning>
...
<Info>Available in version 0.10.0 or later</Info>
...
| Field | Type | Description |
| :-- | :-- | :-- |
| `amount_string` | String | Human-readable representation of the amount. |

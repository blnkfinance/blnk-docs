...
description: "Learn how to send money from a single source to a multiple destinations."
icon: "arrows-maximize"
"og:title": "Multiple destinations - Blnk"
"og:description": "Learn how to send money from a single source to a multiple destinations with the Blnk Ledger."
---
...
3. [Handling transaction references](#3-handling-transaction-references)

## 1. How it works

Consider a customer sending $30,000 USD from their account balance to three people. They want 20% to go to Person A, $10,000 USD to go to Person B, and the remaining amount to Person C. 
...
<Tip>
    You can also include a `meta_data` object (optional) in your request when sending money from multiple sources.
</Tip>

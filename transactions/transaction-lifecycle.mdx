...
<CardGroup>
  <Card title="Transaction statuses" iconType="duotone" icon="tag" href="/transactions/statuses">
    Learn about all transaction statuses and what they mean in your ledger.
  </Card>
  <Card title="Applying inflight" iconType="duotone" icon="plane" href="/transactions/inflight">

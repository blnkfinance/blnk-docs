...
```json Response expandable
{
  ...
  "failed": 0,
  "results": [
    { "transaction_id": "txn_11111111-1111-4111-8111-111111111111", "status": "APPLIED" },
    { "transaction_id": "txn_22222222-2222-4222-8222-222222222222", "status": "APPLIED" }
  ]
}
```
...
```json Response expandable
{
  ...
  "failed": 0,
  "results": [
    { "transaction_id": "txn_11111111-1111-4111-8111-111111111111", "status": "VOID" },
    { "transaction_id": "txn_22222222-2222-4222-8222-222222222222", "status": "VOID" }
  ]
}
```

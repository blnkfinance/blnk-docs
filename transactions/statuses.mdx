...
1. `QUEUED`: This is the default status for any new transaction record. It means your transaction record has been accepted by Blnk, added to a queue and is waiting to be applied. See also: [How Blnk handles concurrency](/resources/concurrency).

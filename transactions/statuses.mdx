...
"og:description": "Understand the various transaction statuses in Blnk, what each status means, and how to respond to changes programmatically"
---
...
<CardGroup>
  <Card title="Inflight transactions" icon="plane" href="inflight"></Card>
</CardGroup>

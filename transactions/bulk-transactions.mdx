...
| `skip_queue` | Boolean | No | Defaults to `false`. When `true`, transactions bypass the queue system. Learn more: [Understanding Queues](/guides/queues#when-to-skip-queues). |

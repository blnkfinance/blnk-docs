...
| `skip_queue` | Boolean | No | Defaults to `false`. When `true`, transactions bypass the queue system. Learn more: [Handling Hot Balances](/guides/hot-balances#when-to-use-each-strategy). |

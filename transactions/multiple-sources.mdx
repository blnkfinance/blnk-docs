...
<Card title="Multiple destinations" href="multiple-destinations" iconType="duotone" icon="arrows-maximize">
...
| `currency` | Asset class code. See [Asset classes](/balances/asset-classes) | Yes | `string` |

...
When using `precise_amount` instead of `amount` in your transaction, use `precise_distribution` for **precise amounts only** in your `sources` array. 

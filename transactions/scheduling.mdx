...
<Card href="/transactions/inflight/updating-inflight#schedule-inflight-commits" title="Schedule inflight commits" icon="calendar-clock">
  Reserve balances now, commit later.
</Card>
